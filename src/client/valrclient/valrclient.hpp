...
namespace VALR {
    ...
    public:
        ...
        static std::vector<Trade> getTrades(std::string pair, bool useAuthenticatedAPI, unsigned long long since = 0, unsigned long long until = 0, unsigned skip = 0, unsigned limit = 20, std::string beforeID = "");
        ...
        static std::string formCancelOrderPayload(std::string pair, std::string id, bool isCustomerOrderID,
                                                  bool isBatch = false);
        static void cancelOrder(std::string pair, std::string id, bool isCustomerOrderID = false);
