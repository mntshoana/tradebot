...
//
//
Fee Client::getFeeInfo(std::string pair){
...
std::vector<UserOrder> Client::getUserOrders(std::string pair,
                                     std::string state,
                                     int limit,
                                     long long before ){
    int args = 0;
...
std::vector<UserTrade> Client::getUserTrades(std::string pair,
                                             long long since,
                                             long long before,
                                             long long after_seq,
